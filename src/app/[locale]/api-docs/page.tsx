      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-text-primary">
              API <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-accent-secondary">Documentation</span>
            </h1>
          ...
          <div className="bg-bg-secondary rounded-2xl p-4 md:p-8 border border-border-primary/50 shadow-xl overflow-hidden">
